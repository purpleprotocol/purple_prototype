...
pub enum Instruction {
    ...
    i64Wrapi32            = 0x86,
    f32TruncSignedi32     = 0x87,
    f32TruncUnsignedi32   = 0x88,
    f64TruncSignedi32     = 0x89,
    f64TruncUnsignedi32   = 0x8a,
    i32ExtendSignedi64    = 0x8b,
    i32ExtendUnsignedi64  = 0x8c,
    f32TruncSignedi64     = 0x8d,
    f32TruncUnsignedi64   = 0x8e,
    f64TruncSignedi64     = 0x8f,
    f64TruncUnsignedi64   = 0x90,
    i32ConvertSignedf32   = 0x91,
    i32ConvertUnsignedf32 = 0x92,
    i64ConvertSignedf32   = 0x93,
    i64ConvertUnsignedf32 = 0x94,
    f64Demotef32          = 0x95,
    i32ConvertSignedf64   = 0x96,
    i32ConvertUnsignedf64 = 0x97,
    i64ConvertSignedf64   = 0x98,
    i64ConvertUnsignedf64 = 0x99,
    f32Promotef64         = 0x9a,
...
impl Instruction {
    pub fn transitions(&self) -> Vec<Transition> {
        match *self {
            ...
            // Datatype conversions
            Instruction::i64Wrapi32             => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::f32TruncSignedi32      => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::f32TruncUnsignedi32    => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::f64TruncSignedi32      => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::f64TruncUnsignedi32    => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::i32ExtendSignedi64     => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::i32ExtendUnsignedi64   => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::f32TruncSignedi64      => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::f32TruncUnsignedi64    => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::f64TruncSignedi64      => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::f64TruncUnsignedi64    => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::i32ConvertSignedf32    => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::i32ConvertUnsignedf32  => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::i64ConvertSignedf32    => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::i64ConvertUnsignedf32  => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::f64Demotef32           => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::i32ConvertSignedf64    => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::i32ConvertUnsignedf64  => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::i64ConvertSignedf64    => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::i64ConvertUnsignedf64  => DEFAULT_TRANSITIONS.to_vec(),
            Instruction::f32Promotef64          => DEFAULT_TRANSITIONS.to_vec(),
